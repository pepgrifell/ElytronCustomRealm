...
public class PepRealmIdentity implements RealmIdentity {

    private final Principal principal;
    private final String password;
    private final Set<String> roles;

    public PepRealmIdentity(Principal principal, String password, Set<String> roles) {
	...
	if (evidence instanceof PasswordGuessEvidence) {
	    ...
	    return Arrays.equals(this.password.toCharArray(), guess.getGuess());
	}
	return false;
    }
